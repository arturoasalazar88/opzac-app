            ...
            <table class="">
                ...
                <tbody>
                    ...
                    @forelse ($reservations as $key => $reservation)
                        ...
                        @if ($key == 0)
                            <tr>
                                <td colspan="10"> <big>{{ strtoupper($last_zone) }}</big> </td>
                            </tr>
                        ...
                        @if ($last_hotel != $reservation->hotel_name || $key == 0)
                            ...
                            @if ($key != 0)
                                ...
                                @if ($last_zone != $reservation->zone_name && $key != 0)
                                    ...
                                    <tr>
                                        <td colspan="10"> <big>{{ strtoupper($reservation->zone_name) }}</big> </td>
                                    </tr>
                                    {{ $last_zone = $reservation->zone_name }}
                                @endif
                            ...
                            @endif
                            <tr>
                                <td colspan="10" style="background: #eee;"><big>{{ $last_hotel }}</big></td>
                            </tr>
                            <tr class="header">
                                <td><b>Folio</b></td>
                                <td><b>Cliente</b></td>
                        ...
                        {{ $total_of_totals += $reservation->total }}
                    @empty
                        <tr>
