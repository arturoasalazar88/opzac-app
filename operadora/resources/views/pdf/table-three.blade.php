            ...
            <table class="">
                ...
                <tbody>
                    ...
                    @forelse ($reservations as $key => $reservation)
                        ...
                        @if ($key == 0)
                            <tr>
                                <td colspan="11"> <big><b>{{ strtoupper($last_zone) }}</b></big> </td>
                            </tr>
                        ...
                        @if ($last_hotel != $reservation->hotel_name || $key == 0)
                            ...
                            @if ($key != 0)
                                ...
                                @if ($last_zone != $reservation->zone_name && $key != 0)
                                    ...
                                    <tr>
                                        <td colspan="11"> <big><b>{{ strtoupper($reservation->zone_name) }}</b></big> </td>
                                    </tr>
                                    {{ $last_zone = $reservation->zone_name }}
                                @endif
                            ...
                            @endif
                            <tr>
                                <td colspan="11" style="background: #eee;"><big><b>{{ $last_hotel }}</b></big></td>
                            </tr>
                            <tr class="header">
                                <td><b>Folio</b></td>
                                <td><b>Cliente</b></td>
