...
@section('content')
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="row">
                <div class="col s12">
                    <h5>Reporte de ventas por tour <br><small>(Se muestran únicamente los que hayan tenido ventas)</small> </h5>
    ...
    <script>
        ...
        $("#resend").on('click', function(){
            ...
            window.location = "{{ route('sales_index') }}"+"?date1="+$("#date1").val()+"&date2="+$("#date2").val();
        });
    </script>
    <script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            labels: {!! $tours !!},
            datasets: [{
                label: 'Ventas de tours por periodo de tiempo',
                // data: [12, 14, 3, 5, 2],
                data: {!! $totals !!},
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
