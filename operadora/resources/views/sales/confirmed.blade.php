...
@section('content')
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="row">
                <div class="col s12">
                    <h5>Reporte del número de reservas confirmadas vs no confirmadas </h5>
    ...
    <script>
        ...
        $("#resend").on('click', function(){
            ...
            window.location = "{{ route('sales_confirmed') }}"+"?date1="+$("#date1").val()+"&date2="+$("#date2").val();
        });
    </script>
    <script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Reservas confirmadas vs no confirmadas',
                // data: [12, 14, 3, 5, 2],
