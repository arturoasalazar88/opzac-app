            ...
            <table class="">
                ...
                <tbody>
                    ...
                    @forelse ($reservations as $key => $reservation)
                        ...
                        @if ($last_tour != $reservation->tour_name || $key == 0 || $last_departure != $reservation->horario)
                            {{ $last_tour = $reservation->tour_name }}
                            {{ $last_departure = $reservation->horario }}
                            ...
                            @endif
                            <tr>
                                <td colspan="13" style="background: #eee;"><big><b>{{ $last_tour }}</b></big></td>
                            </tr>
                            <tr class="header">
                                <td><b>Folio</b></td>
                                <td><b>Cliente</b></td>
                        ...
                        <tr>
                            ...
                            <td data-label="Adeudo">{{ $reservation->total }}</td>
                            <td data-label="Adeudo">{{ $reservation->remaining }}</td>
                            <td data-label="resto">{{ $reservation->payment_method }}</td>
