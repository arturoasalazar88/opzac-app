...
@section('content')
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="row">
                <div class="col s12">
                    <h5>Reporte de ventas por Usuario <br><small>(Se muestran únicamente los 10 usuarios que han tenido mayores ventas  )</small> </h5>
    ...
    <script>
        ...
        $("#resend").on('click', function(){
            ...
            window.location = "{{ route('sales_users') }}"+"?date1="+$("#date1").val()+"&date2="+$("#date2").val();
        });
    </script>
    <script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            labels: {!! $users !!},
            datasets: [{
                label: 'Ventas de reservas por usuario en periodo de tiempo',
                // data: [12, 14, 3, 5, 2],
                data: {!! $totals !!},
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
